 ...
 *
 * <p>Activated by {@code rosecloud.security.oauth2.enabled=true} in a servlet app. Configures
...
@ConditionalOnProperty(prefix = "rosecloud.security.oauth2", name = "enabled", havingValue = "true")

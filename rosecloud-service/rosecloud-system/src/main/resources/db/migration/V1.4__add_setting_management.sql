...
(45, 2, '配置键查询', 2, NULL, NULL, 'system:setting-key:list', NULL, 10, 1, 1, 0),
(46, 2, '配置键新增', 2, NULL, NULL, 'system:setting-key:add', NULL, 11, 1, 1, 0),
(47, 2, '配置键修改', 2, NULL, NULL, 'system:setting-key:edit', NULL, 12, 1, 1, 0),
(48, 2, '配置键删除', 2, NULL, NULL, 'system:setting-key:del', NULL, 13, 1, 1, 0),
(49, 2, '系统配置查询', 2, NULL, NULL, 'system:setting:list', NULL, 14, 1, 1, 0),
(50, 2, '系统配置修改', 2, NULL, NULL, 'system:setting:edit', NULL, 15, 1, 1, 0),
(51, 2, '系统配置删除', 2, NULL, NULL, 'system:setting:del', NULL, 16, 1, 1, 0)
ON DUPLICATE KEY UPDATE name = VALUES(name);

INSERT INTO sys_role_menu (id, role_id, menu_id) VALUES
(45, 1, 45), (46, 1, 46), (47, 1, 47), (48, 1, 48),
(49, 1, 49), (50, 1, 50), (51, 1, 51)

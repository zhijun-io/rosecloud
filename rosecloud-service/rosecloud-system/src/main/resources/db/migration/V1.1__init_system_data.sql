...
INSERT INTO sys_user (id, email, nickname, status, tenant_id, deleted)
VALUES (1, 'admin@rosecloud.local', '平台管理员', 1, NULL, 0)
ON DUPLICATE KEY UPDATE nickname = VALUES(nickname), status = 1, email = VALUES(email);

INSERT INTO user_credential (id, user_id, password, password_changed_time, deleted)
VALUES (1, 1, '$2a$10$ipYqBLPr/rGe5c1AVgvWoODGrthzi8FKOjGE7HZQQ0EATEPaY/OJa', CURRENT_TIMESTAMP, 0)
